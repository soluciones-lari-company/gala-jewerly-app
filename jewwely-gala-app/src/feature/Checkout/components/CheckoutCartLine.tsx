...
const CheckoutCartLine = ({
  ...
  const _deleteLine = () => {
    ...
    client
      .deleteLineFromOrder(idOrder, line.itemSerieId ?? "", command)
      .then((result) => {
    ...
    <>
      ...
      <div className="cart-item">
        ...
        <div className="cart-item-body">
          <div className="row">
            <div className="col">
              <h5 className="cart-item-title">{line.descripcion}</h5>
              <small className="cart-item-subtitle">{line.serieCode}</small>
              <div>
                <ul className="list list--horizontal list--separated fs-14 text-muted mt-1">
                  <li>
                    Precio <span className="text-dark">${line.unitPrice}</span>
                  </li>
                  <li>
                    Cantidad <span className="text-dark">{line.quantity}</span>
                  </li>
                </ul>
              </div>
            </div>
...
export default CheckoutCartLine;
