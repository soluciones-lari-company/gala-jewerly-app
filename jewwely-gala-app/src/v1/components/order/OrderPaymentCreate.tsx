...
const OrderPaymentCreate = ({
  idOrder,
  onPaymentAdded,
  onClose,
  show,
  pendingToPay,
}: IOrderPaymentCreateProps) => {
  // contexts
    ...
    >
      ...
      <Modal.Footer>
        ...
        <Button
          ...
          onClick={() => savePayment()}
          disabled={
            paymentTotal === 0 || paymentMethod === "" || paymentAccount === ""
          }
        >
...
export default OrderPaymentCreate;
